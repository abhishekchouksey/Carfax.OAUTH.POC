...
namespace ImageGallery.Client.Controllers
{
    ...
    public class GalleryController : Controller
    {
        ...
        {
            var _idpClient = _httpClientFactory.CreateClient("IDPClient");
            ...
            var userInfoResponse = await _idpClient.GetUserInfoAsync(new UserInfoRequest
            {
        ...
        {
            var identityToken = await HttpContext.GetTokenAsync(OpenIdConnectDefaults.AuthenticationScheme, OpenIdConnectParameterNames.IdToken);
